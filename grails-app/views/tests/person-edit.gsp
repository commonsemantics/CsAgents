	...
	<body>
		<div class="csc-main">
			...
			<g:form method="post" >
				...
				<div class="buttons">
					<span class="button">
						<g:actionSubmit class="save" action="updatePerson" value="${message(code: 'org.commonsemantics.grails.users.profile.update', default: 'Update Profile')}" />
					</span>
					<span class="button">
						<g:actionSubmit class="cancel" action="showPerson" value="${message(code: 'org.commonsemantics.grails.general.cancel', default: 'Cancel')}" />
					</span>
				</div>
			</g:form>
		</div>
